...
public:
	...
	*/
	...
	/**
	Load an XML file from disk to a char buffer.
	Returns XML_NO_ERROR (0) on success, or
	an errorID.
	*/
	XMLError XMLDocument::LoadFileToBuffer(const wchar_t* const filename, char** buffer);

	/**
	Load an XML file from a char buffer.
	Returns XML_NO_ERROR (0) on success, or
	an errorID.
	*/
	XMLError XMLDocument::LoadFileFromBuffer(const char* const buffer);
    ...
    */
	...
	void SetWError( XMLError error, const wchar_t* str1, const wchar_t* str2);
...
private:
    ...
    char*       _charBuffer;
	const wchar_t* _errorWstr1;
	const wchar_t* _errorWstr2;
